...
# Save as output file
estOut = signif(est, 4)
saveRDS(est, file.path(OUTRESULTS, "Estimated_CNAs_per_signature_and_sample.rds"))
write.table(estOut, file.path(OUTRESULTS, "Estimated_CNAs_per_signature_and_sample.txt"), 
